...
Converted to a Network Flow graph with bandwidths assigned to each edge. The bandwidths are generated based on the degree of the nodes, with some random noise added to simulate real-world variability.
